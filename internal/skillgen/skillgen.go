...
const (
	GeneratedMarker = "Generated by taxmate-australia-skills. Refresh before relying on volatile values."
...
func rulesMarkdown(t Topic, sources []Source, checkedAt string) string {
	...
	b.WriteString("## Source-backed scope\n\n")
	if len(sources) == 0 {
