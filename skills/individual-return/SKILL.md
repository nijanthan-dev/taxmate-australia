...
- shared, itemized company and partnership income/deduction worksheets in isolated entity sections, including supplied totals, records, GST/BAS and review signals, plus partnership trading-stock and capital-allowance facts, without final treatment;
...
Do not fully handle company, trust, partnership, full supplementary, complete CGT schedule, or advanced OCR/template extraction workflows beyond the supported prep-only entity skeleton, statement routing, and company/partnership income-deduction worksheets. Detect and route tax-treatment decisions to the most specific installed skill or mark `Accountant review`.
