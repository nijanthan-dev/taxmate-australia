...
- one general non-crypto/non-rental CGT event schedule row with event type, asset, owner, acquisition date, disposal date, proceeds, cost base, records, basic review signals, source provenance, and explicit no-final-calculation wording;
...
14. For general non-crypto/non-rental CGT event prep, collect one event type, asset description, owner or ownership share, acquisition date, disposal date, proceeds, cost base, records, and basic review signals such as mixed/private/business use, exemption, discount, and concession flags. Explicit no-CGT answers without facts should skip the workflow; no-CGT plus facts, missing records, unknown or malformed amounts/dates, ownership uncertainty, and review flags stay Evidence or `Accountant review`. Preserve `0` proceeds or cost base and false review flags. Never calculate a final capital gain or loss, decide final CGT treatment, or call the row copy-ready.
