...
- shared, itemized company and partnership income/deduction worksheets in isolated entity sections, including supplied totals, records, GST/BAS and review signals, company loss/continuity/asset/depreciation/capital-allowance facts, and partnership trading-stock/capital-allowance facts, without final treatment;
...
Do not fully handle company, trust, partnership, full supplementary, complete CGT schedule, or advanced OCR/template extraction workflows beyond the supported prep-only entity skeleton, statement routing, company/partnership income-deduction worksheets, and company loss/asset review rows. Detect and route tax-treatment decisions to the most specific installed skill or mark `Accountant review`.
