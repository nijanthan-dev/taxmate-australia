...
Do not fully handle company, trust, partnership, full supplementary, complete CGT schedule, or advanced OCR/template extraction workflows beyond the supported prep-only entity skeleton and statement routing. Detect and route tax-treatment decisions to the most specific installed skill or mark `Accountant review`.
