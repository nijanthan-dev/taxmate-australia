...
2. **Apply Project Standards**: Follow the established coding standards from project instruction files, including AGENTS.md or CLAUDE.md when present, including:
...
2. Explore adjacent code, scripts, tests, and platform assumptions before changing behavior-sensitive paths
