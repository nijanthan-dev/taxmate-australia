...
- separate prep-only company, trust, and partnership intake sections, including company dividend/franking-account/Division 7A review, trust CGT/franked-distribution/streaming/allocation review, isolated trust-beneficiary and partnership-partner statement rows, official-source provenance, missing-evidence prompts, and accountant-review handoff; no final allocation, entitlement, CGT, franking, Division 7A, lodgment, or advice;
...
For an entity return, provide supplied facts, records, source links, checked-at dates, and review signals. Company inputs may include income/deductions, losses, assets, dividends, franking-account movements, and Division 7A facts. Trust inputs may include capital-gain components, CGT discount signals, franked distributions and franking credits, deed/streaming/resolution facts, and beneficiary component allocations. Partnership inputs may include income/deductions, trading stock, capital allowances, loss/allocation, GST/BAS, PSI, and structure facts. TaxMate keeps rows in the matching entity output, preserves missing resolutions, unknown amounts, unsupported allocations, and uncertainty, and does not calculate a final return position, decide CGT/franking/streaming/allocation treatment, determine PSI, lodge BAS, or lodge a return.
```
