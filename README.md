...
- separate prep-only company, trust, and partnership intake sections, including isolated trust-beneficiary and partnership-partner statement rows, official-source provenance, missing-evidence prompts, and accountant-review handoff; no allocation, entitlement decision, lodgment, or final advice;
