...
- separate prep-only company, trust, and partnership intake sections, including company dividend/franking-account/Division 7A review, isolated trust-beneficiary and partnership-partner statement rows, official-source provenance, missing-evidence prompts, and accountant-review handoff; no allocation, entitlement, franking, Division 7A, lodgment, or final advice;
...
For a company or partnership entity return, provide itemized income and expense/deduction categories with supplied amounts, accounting records, evidence, GST/BAS overlap, and review signals. Company inputs may also include prior/current-year loss facts, ownership/business-continuity signals, depreciating assets, asset pools, methods, instant-asset-write-off flags, capital-allowance records, dividends paid/received, franking-account movements and FDT signals, shareholder/director/associate benefits, loans, repayments, written terms, benchmark-interest facts, distributable-surplus/retained-profit signals, interposed/trust facts, and evidence status. Partnership inputs may include trading-stock, capital-allowance, loss/allocation, GST registration and BAS period/overlap, PSI, and business-structure facts. TaxMate keeps these rows in dedicated company or partnership output, preserves missing evidence and uncertainty, and does not calculate a final return position, franking account, Division 7A result, lodge BAS, determine PSI, or decide allocations.
```
