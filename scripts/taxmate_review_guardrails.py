...
def check_taxpack_output_layer_text(text: str) -> List[Finding]:
    ...
    required = [
        ...
        "taxmate_entity_routing.SOURCES[kind]",
                ...
                '"key": "raw-facts"',
                "supplied_row_kind",
                're.fullmatch(rf"{re.escape(base_row_kind)}(?:-[a-z0-9]+)*", supplied_row_kind)',
    ]
    ...
    findings.extend(
        fail_if_missing(
            ...
            [
                ...
                "def _valid_amount_value(",
                "def _evidence_available(",
                "def _child_fact_pairs(",
                "def _child_gaps(",
                "def _child_followup_row(",
                "def _unresolved_child_row(",
                ".is_finite()",
                "return valid and has_amount",
                'field == "distributions" and isinstance(child.get(field), bool)',
                '"entity-return-trust-beneficiary-statement"',
                ...
                "def review_values_equivalent(",
                "def merge_alias_conflicts(",
                "def _merge_review_item(",
                'key == "_alias_conflicts" and isinstance(value, dict)',
                "taxmate_entity_routing.merge_alias_conflicts(",
                "def _review_alias_groups(",
                "def _review_aliases_conflict(",
                ...
                'not (section == "division-7a" and isinstance(raw[field], bool))',
                'not (field == "loan" and _false_signal(raw.get(field)))',
                ...
                "section in COMPANY_ALWAYS_REVIEW_SECTIONS",
                ...
                "def _group_trust_review_fields(",
                "def _trust_review_has_alias_conflict(",
                "def _trust_resolution_present(",
                "def _trust_deed_evidence_present(",
                "def _franking_integrity_signal_present(",
                ...
                'worksheet in TRUST_REVIEW_COLLECTIONS',
                'f"entity-return-trust-{section}"',
    ...
    findings.extend(
        fail_if_missing(
            ...
            [
                ...
                "beneficiary component allocations",
                "missing resolutions",
                "unsupported allocations",
                "never reuse individual",
                "does not calculate trust CGT",
            ],
        )
    )
    findings.extend(
        fail_if_missing(
            ...
            [
                ...
                "def partnership_trust_flat_has_statement_facts(",
                "def partnership_trust_flat_has_substantive_facts(",
                "def merge_partnership_trust_complements(",
                "def coalesce_partnership_trust_records(",
                "def normalize_partnership_trust_structured_item(",
                "def partnership_trust_item_complete(",
                'conflicts[f"structured_flat_{canonical}"]',
                "def first_meaningful_present(",
                "def source_provenance_values(",
                "def checked_at_provenance_values(",
                "def provenance_has_errors(",
                "def canonical_review_status(",
                "def routing_handoff_facts(",
                "def scalar_alias_values(",
...
def check_generated_artifact_contract(root: Path) -> List[Finding]:
    return fail_if_file_missing(
        ...
        [
            ...
            "def entityRuntimeInstructionSkill(",
