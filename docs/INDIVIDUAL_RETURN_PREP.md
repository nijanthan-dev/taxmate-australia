...
Individual partnership-share and residual trust-beneficiary/share statements use a separate supplementary-income route. Collect entity name, ABN/TFN where supplied, statement status, income and loss components, withholding, credits, source URLs, checked-at dates, and evidence status. This route does not duplicate managed fund/ETF/AMIT, investment trust-distribution, or trust entity-review rows. Missing statements, malformed amounts, mixed components, losses, uncertain credits, entitlement or allocation questions, and entity-return context stay Evidence or `Accountant review`. Final partnership and trust treatment remains out of scope.

Company, trust, and partnership return skeletons use separate prep-only sections. Company intake collects identity, ABN/ACN/TFN, income year, residency, activity, directors/shareholders, and related-entity signals. Trust intake collects identity, TFN/ABN, trustee, type, income year, residency, deed/election evidence, beneficiary signals, capital-gain components and discount signals, franked distributions and franking credits, streaming/resolution facts, and beneficiary component allocations. Partnership intake collects identity, ABN/TFN, income year, partners, share percentages, activity, accounting basis, and agreement evidence. Flat, nested, and itemized entity inputs share the same fail-closed routing contract. Missing resolutions, unknown amounts, unsupported allocations, and other missing, malformed, conflicting, structural, residency, related-party, deed, beneficiary, partner-share, or accounting-basis facts remain Evidence or `Accountant review`. Entity facts never enter individual rows; TaxMate does not calculate trust CGT or decide discount, franking, streaming, entitlement, or allocation treatment.

Company and partnership entity sections also accept shared itemized `income_items` and `deduction_items`, supplied totals, accounting-record evidence, GST/BAS interaction, private/non-deductible, related-party, capital/depreciation, PSI, and business-structure signals. Company review rows additionally accept current/prior/carried-forward loss facts, ownership/control and business-continuity signals, depreciating assets, asset pools, depreciation methods, instant-asset-write-off flags, capital allowances, dividends paid/received, franked/unfranked amounts, franking credits, franking-account opening/credit/debit/closing and deficit/FDT signals, shareholder/director/associate payments, loans, asset use, debt forgiveness, repayments, complying agreements, written loan terms, interest/benchmark-interest facts, maturity dates, minimum-yearly-repayment signals, distributable-surplus/retained-profit signals, interposed/trust facts, private expenses, records, and evidence status. Deferred `dividend`, `dividends`, `franking`, and `division-7a` income categories migrate into dedicated company review rows without duplicate generic income rows. Partnership review rows additionally accept current/prior loss facts, partner loss allocations, GST registration and BAS period/overlap, PSI indicators, business-structure indicators, and records. Company categories follow the 2026 company instructions and verified business-loss, capital-expense, dividend, franking, and Division 7A sources. Partnership categories follow the 2026 partnership instructions plus verified business-loss, GST-registration, BAS, and PSI sources. Unknown categories, malformed/non-finite amounts, missing evidence, allocation conflicts, BAS overlap, PSI/structure uncertainty, alias conflicts, unsupported facts, total mismatches, invalid provenance, and review signals remain Evidence or `Accountant review`; valid `0`, `false`, and negative supplied values stay visible. TaxMate never decides loss use or allocation, continuity, depreciation method, capital-allowance treatment, franking/FDT, Division 7A, distributable surplus, minimum yearly repayment, PSI, final taxable income or deductions, fills official forms, lodges BAS, or lodges a return.

Trust review collections accept capital-gain items, discount eligibility/application signals, franked distributions, franking credits, streaming and specific-entitlement signals, deed/resolution records, the financial-benefit and recorded-in-character conditions, component character and recording dates, franking-integrity review signals, and beneficiary component allocations. They route only to `trust_items`; they never reuse individual investment or CGT rows. Missing or contradictory deed power, entitlement-condition, recording-condition, recording-date, resolution, statement, or franking-integrity facts, unknown or malformed component amounts, unsupported allocation percentages or bases, alias conflicts, invalid source provenance, and invalid checked-at dates produce evidence rows and stay `Accountant review`. The verified ATO trust-streaming source supports the review context only. TaxMate does not test recording deadlines, work out a capital gain, apply a discount, determine specific entitlement, allocate components, or decide franking treatment.
...
| Trust CGT/franking/streaming review | Structured | Prep-only trust rows with resolution and allocation evidence queues; no final calculation or treatment. |
...
- `0` trust capital-gain, franked-distribution, franking-credit, and beneficiary-allocation facts plus `false` discount, streaming, deed, specific-entitlement, and recorded-in-character signals stay visible in isolated trust review rows.
- `0` company/partnership income, loss/allocation, expense, asset, pool, depreciation, stock, and capital-allowance facts, negative supplied worksheet amounts, and `false` ownership-continuity, instant-write-off, GST registration/BAS overlap, private-use, non-deductible, election, PSI, structure, or balancing-adjustment signals stay visible in isolated entity worksheets.
