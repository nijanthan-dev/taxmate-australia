...
Company and partnership entity sections also accept shared itemized `income_items` and `deduction_items`, supplied totals, accounting-record evidence, GST/BAS interaction, private/non-deductible, related-party, capital/depreciation, PSI, and business-structure signals. Company review rows additionally accept current/prior/carried-forward loss facts, ownership/control and business-continuity signals, depreciating assets, asset pools, depreciation methods, instant-asset-write-off flags, capital allowances, and records. Partnership review rows additionally accept current/prior loss facts, partner loss allocations, GST registration and BAS period/overlap, PSI indicators, business-structure indicators, and records. Company categories follow the 2026 company instructions and verified business-loss/capital-expense sources. Partnership categories follow the 2026 partnership instructions plus verified business-loss, GST-registration, BAS, and PSI sources. Unknown categories, malformed/non-finite amounts, missing evidence, allocation conflicts, BAS overlap, PSI/structure uncertainty, alias conflicts, unsupported facts, total mismatches, invalid provenance, and review signals remain Evidence or `Accountant review`; valid `0`, `false`, and negative supplied values stay visible. Company dividends/franking/Division 7A remain a later review slice. TaxMate never decides loss use or allocation, continuity, depreciation method, capital-allowance treatment, PSI, final taxable income or deductions, fills official forms, lodges BAS, or lodges a return.
