...
Company and partnership entity sections also accept shared itemized `income_items` and `deduction_items`, supplied totals, accounting-record evidence, GST/BAS interaction, private/non-deductible, related-party, capital/depreciation, PSI, and business-structure signals. Company review rows additionally accept current/prior/carried-forward loss facts, ownership/control and business-continuity signals, depreciating assets, asset pools, depreciation methods, instant-asset-write-off flags, capital allowances, and records. Company categories follow the 2026 company instructions and verified business-loss/capital-expense sources. Partnership categories follow the 2026 partnership income, deduction, trading-stock, and capital-allowance instructions. Unknown categories, malformed/non-finite amounts, missing evidence, alias conflicts, unsupported facts, total mismatches, invalid provenance, and review signals remain Evidence or `Accountant review`; valid `0`, `false`, and negative supplied values stay visible. Company dividends/franking/Division 7A remain a later review slice. Partnership loss allocation and detailed GST/BAS or PSI determination remain later review slices. TaxMate never decides loss use, continuity, depreciation method, capital-allowance treatment, final taxable income or deductions, fills official forms, or lodges.
...
- `0` company/partnership income, loss, expense, asset, pool, depreciation, stock, and capital-allowance facts, negative supplied worksheet amounts, and `false` ownership-continuity, instant-write-off, GST/BAS, private-use, non-deductible, election, PSI, structure, or balancing-adjustment signals stay visible in isolated entity worksheets.
